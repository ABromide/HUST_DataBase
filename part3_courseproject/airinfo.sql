...
CREATE TABLE OrderInfo(
	...
	IDnumber CHAR(20) NOT NULL, -- 身份证号
...
LOAD DATA INFILE '/var/lib/mysql-files/DirectInfo.csv' into table DirectInfo character set utf8 fields terminated by ',' lines terminated by '\n' ignore 1 lines;

LOAD DATA INFILE '/var/lib/mysql-files/TransitInfo2.csv' into table TransitInfo character set utf8 fields terminated by ',' lines terminated by '\n' ignore 1 lines;

LOAD DATA INFILE '/var/lib/mysql-files/SeatInfo.csv' into table SeatInfo character set utf8 fields terminated by ',' lines terminated by '\n' ignore 1 lines;
